...
export class PatientsListComponent implements OnInit {
  ...
  constructor(private usersService: AdminService, private route: Router, private auth: AuthService) { 
  ...
  loadPatients(): void {
    this.isLoading = true;
    this.usersService.getPatients(this.currentUser.id).subscribe(data => {
      this.patients = data;
